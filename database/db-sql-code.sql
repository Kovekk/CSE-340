...
-- W02 Task 4 -> adjust the description of GM Hummer to say a huge interior instead of small interiors
UPDATE inventory 
SET inv_description = replace(inv_description, 'the small interiors', 'a huge interior')
WHERE inv_id = 10;

  -- W02 Task 6 -> udpated the inventory table to include /vehicles in the inv_image and inv_thumbnail columns
UPDATE inventory
